...
-- This function uses a transaction to ensure all-or-nothing booking
-- Note: SECURITY DEFINER allows the function to run with elevated privileges
...
BEGIN
  ...
  -- If any seats are not available, rollback and return error
...
EXCEPTION
  WHEN lock_not_available THEN
    -- Another transaction is already booking these seats
    RETURN json_build_object(
      'success', false,
